...
{/* <div className="p-6 mt-8">
        ...
        <div className="p-2 my-8 border-t-2 border-l-2 border-dotted border-zinc-300">
            <p className="text-justify">After a rewarding 17-year tenure owning a thriving beauty salon, I've transitioned into the dynamic realm of IT and Software Development.</p>
            <p className="text-justify">Having already completed a Certificate IV in IT and with just one month remaining in the project-based bootcamp at She Codes Australia, I'm eager to explore opportunities as a Junior Frontend Developer.</p>
            <p className="text-justify">This career shift reflects my passion for technology and coding, and I'm excited to apply my skills and knowledge in this exciting new chapter. </p>
        </div>

        <div className="about-me-pic-2">
            <img src={rainbow} alt="picture of the rainbow cargo containers art installation in Fremantle WA"/>
        </div>

        <div className="about-me-2"></div>
            <p>Outside of coding, I love soaking up nature's wonders through hiking and snorkeling. As a dedicated mom, wife, and enthusiastic member of a women's softball team, I thrive in teamwork and treasure moments with my loved ones. You'll catch me savoring quotes, making lists, enjoying coffee, and relishing any meal that lets me skip kitchen duty!</p>
            <p>In a nutshell, my transition from salon owner to aspiring IT pro embodies my ongoing quest for personal growth and adventure. I'm pumped for what lies ahead and can't wait to put my fresh skills to work in this dynamic field!</p>
        </div> */}
